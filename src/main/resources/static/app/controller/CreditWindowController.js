Ext.define('Bank.controller.CreditWindowController', {
    extend: 'Ext.app.Controller',
    views: ['CreditWindowView'],
    refs: [{
        ref: 'grid',
        selector: 'credit',
    }],
    init: function() {
        this.control({
            'credit-window button[action=reset]': {
                click: this.resetClick
            },
            'credit-window button[action=save]': {
                click: this.saveClick
            },
            'credit-window button[action=cancel]': {
